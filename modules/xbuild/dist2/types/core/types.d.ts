import { ChunkFileNamesFunction, OutputOptions, RolldownOptions } from "rolldown";
...
export type XBuildOutputOptions = Omit<OutputOptions, "chunkFileNames"> & {
    chunkFileNames?: string | ((chunkInfo: Parameters<ChunkFileNamesFunction>[0], format: string) => string | undefined | null | void);
};
...
export type UserConfig = FuncEnable<XBuildConfig | Promise<XBuildConfig>, [
    {
        mode: XBuildMode;
    }
]>;
