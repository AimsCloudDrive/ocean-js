...
export interface IComponent<Props extends IComponentProps<unknown> = IComponentProps<unknown>, Events extends IComponentEvents = IComponentEvents> extends IEvent<Events> {
